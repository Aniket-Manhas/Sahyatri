    ...
    <header className="header bg-bg-primary shadow-md relative">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav
          className={`${
            isMobileMenuOpen
              ? "absolute top-full left-0 right-0 bg-bg-primary border-t border-border shadow-lg md:border-none md:shadow-none"
              : "hidden"
          } md:block md:static`}
        >
          <ul className="flex flex-col md:flex-row md:space-x-6 p-4 md:p-0">
            <li>
              <Link
                to="/"
                className="block py-2 md:py-0 hover:text-accent-primary transition"
        ...
        <div className="flex items-center space-x-4">
          ...
          {currentUser ? (
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/profile"
                className="profile-link hover:text-accent-primary transition"
              >
